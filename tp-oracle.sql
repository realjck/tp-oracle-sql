...
ADD CONSTRAINT commande_pk PRIMARY KEY (
	commande_uid
)
ENABLE;
...
-- Ajout clé primaire
ALTER TABLE produit
ADD CONSTRAINT produit_pk PRIMARY KEY (
	produit_uid
)
ENABLE;
...
ADD CONSTRAINT ingredient_pk PRIMARY KEY (
	ingredient_uid
)
ENABLE;
...
ADD CONSTRAINT fournisseur_pk PRIMARY KEY (
	fournisseur_uid
)
ENABLE;
...
-- Ajout clé primaire
ALTER TABLE achat
ADD CONSTRAINT achat_pk PRIMARY KEY (
	achat_uid
)
ENABLE;
...
ADD CONSTRAINT commande_produit_pk PRIMARY KEY (
	commande_produit_uid
)
ENABLE;

-- Création clés étangères entre les trois tables
ALTER TABLE commande_produit
ADD CONSTRAINT commande_produit_fk FOREIGN KEY (
	commande_uid
)
REFERENCES commande (
	commande_uid
...
ALTER TABLE commande_produit
ADD CONSTRAINT produit_commande_fk FOREIGN KEY (
	produit_uid
)
REFERENCES produit (
	produit_uid
...
ADD CONSTRAINT produit_ingredient_pk PRIMARY KEY (
...
-- Création clés étangères entre les trois tables
ALTER TABLE produit_ingredient
ADD CONSTRAINT produit_ingredient_fk FOREIGN KEY (
	produit_uid
)
REFERENCES produit (
	produit_uid
...
ALTER TABLE produit_ingredient
ADD CONSTRAINT ingredient_produit_fk FOREIGN KEY (
	ingredient_uid
)
...
ADD CONSTRAINT fournisseur_ingredient_pk PRIMARY KEY (
...
-- Création clés étangères entre les trois tables
ALTER TABLE fournisseur_ingredient
ADD CONSTRAINT fournisseur_ingredient_fk FOREIGN KEY (
	fournisseur_uid
)
...
ALTER TABLE fournisseur_ingredient
ADD CONSTRAINT ingredient_fournisseur_fk FOREIGN KEY (
	ingredient_uid
)
REFERENCES ingredient (
	ingredient_uid
...
--Creation d'une clé étrangere
ALTER TABLE achat
ADD CONSTRAINT achat_fournisseur_ingredient_fk FOREIGN KEY (
	fournisseur_ingredient_uid
)
REFERENCES fournisseur_ingredient (
	fournisseur_ingredient_uid
)
ENABLE;
